document.addEventListener("DOMContentLoaded", function () {
    ...
    const commands = {
        ...
        <span class="blue">  /  (--)  \\  </span>  Email: <a href="mailto:kaisenj606@gmail.com" class="custom-link">contact@nick.in</a>
        <span class="blue"> /  /    \\  \\ </span>  GitHub: <a href="https://github.com/nikunjy-ai" target="_blank" class="custom-link">GitHub.com/NikunjYadav021</a>
        <span class="blue">/___\\    /___\\</span>  LinkedIn: <a href="www.linkedin.com/in/nikunjyadav021" target="_blank" class="custom-link">LinkedIn.com/in/NikunjYadav021</a>
        </pre>`;
        },

        github: () => {
            window.open("https://github.com/nikunjy-ai", "_blank");
            return `Opening <a href="https://github.com/nikunjy-ai" target="_blank" class="custom-link">GitHub/nikunjyadav</a>...`;
        },

        linkedin: () => {
            window.open("www.linkedin.com/in/nikunjyadav021", "_blank");
            return `Opening <a href="www.linkedin.com/in/nikunjyadav021" target="_blank" class="custom-link">LinkedIn/NikunjYadav021</a>...`;
        },
        ...
        - Hindi Call Transcriber: VoxBridge is a Hindi audio to English and Hindi transcriber.<br>
        - Subdomain Distribution Portal: CloudFrost is a portal that allows users to recieve free sub domains with DNS support.<br>
        ...
        resume: () => {
            ...
            link.href = "/Users/nikunjyadav/Desktop/untitled folder/Nick's Resume.pdf";
